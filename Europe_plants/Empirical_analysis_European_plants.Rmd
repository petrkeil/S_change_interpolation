---
title: "Empiciral analysis - European plants"
author: "Petr Keil"
date: "14/3/2022"
output: 
  html_document: 
...
# Import libraries, data, and other objects
...
## Grid cell coordinates and areas
...
RF.plants <- randomForest(S ~ Time + Area + Lat + Lon, 
                 ...
                 sampsize = 40,
                 n.trees = 1000)
RF.plants$importance
varImpPlot(RF.plants, type = 2)
```
...
## Map of raw data from Essl et al. 2013
...
png("eu_maps.png", res=150, width=1200, height=700)
grid.arrange(map.1, map.2 , nrow=1, ncol=2)
dev.off()
